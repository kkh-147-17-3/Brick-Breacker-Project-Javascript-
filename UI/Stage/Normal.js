...
import Stage1 from "./Normal/ItemMap1.js";
import Stage2 from "./Normal/Normal.js";
import Stage3 from "./Normal/impact1.js";
...
export default class Normal {
    ...
    draw(){
        ...
        this.ctx.fillStyle = "#6E6CE0";
        this.ctx.fillText("NORMALMODE", 410, 90);
        this.ctx.closePath();
        //노랑색
        this.ctx.beginPath();
        this.ctx.font = "75pt Orbitron";
        this.ctx.textAlign = "center";
        this.ctx.fillStyle = "#FFEC94"
        this.ctx.fillText("NORMALMODE", 420, 100);
        this.ctx.closePath();
        ...
        this.ctx.textAlign = "center";
        this.ctx.fillStyle = "#6E6CE0";
        this.ctx.fillText("Creator: HAN TAE HEE", this.canvas.width - 376, 325);
        this.ctx.closePath();
        //노랑색
        this.ctx.beginPath();
        this.ctx.font = "40pt Orbitron";
        this.ctx.textAlign = "center";
        this.ctx.fillStyle = "#FFEC94"
        this.ctx.fillText("Creator: HAN TAE HEE", this.canvas.width - 370, 330);
        this.ctx.closePath();
