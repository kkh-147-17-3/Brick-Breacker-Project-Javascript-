...
import Stage1 from "./Hard/HIT.js";
import Stage2 from "./Hard/heart3.js";
import Stage3 from "./Hard/impact.js";
...
export default class Baby {
    ...
    draw(){
        ...
        this.ctx.fillStyle = "#E3DB39";
        this.ctx.fillText("HARDMODE", 330, 90);
        this.ctx.closePath();
        //노랑색
        this.ctx.beginPath();
        this.ctx.font = "75pt Orbitron";
        this.ctx.textAlign = "center";
        this.ctx.fillStyle = "#BF30E8"
        this.ctx.fillText("HARDMODE", 340, 100);
        this.ctx.closePath();
