...
import Stage1 from "./Easy/stage1.js";
import Stage2 from "./Easy/Heart.js";
import Stage3 from "./Easy/diamond.js";
...
export default class Easy {
    ...
    draw(){
        ...
        this.ctx.fillStyle = "#B11DF5";
        this.ctx.fillText("EASYMODE", 320, 90);
        this.ctx.closePath();
        //노랑색
        this.ctx.beginPath();
        this.ctx.font = "75pt Orbitron";
        this.ctx.textAlign = "center";
        this.ctx.fillStyle = "#CDFF38"
        this.ctx.fillText("EASYMODE", 330, 100);
        this.ctx.closePath();
        ...
        this.ctx.fillStyle = "#B11DF5";
        this.ctx.fillText("Creator: KIM KYUNG HWAN", this.canvas.width-8, 325);
        this.ctx.closePath();
        //노랑색
        this.ctx.beginPath();
        this.ctx.font = "40pt Orbitron";
        this.ctx.textAlign = "right";
        this.ctx.fillStyle = "#CDFF38"
        this.ctx.fillText("Creator: KIM KYUNG HWAN", this.canvas.width, 330);
        this.ctx.closePath();
