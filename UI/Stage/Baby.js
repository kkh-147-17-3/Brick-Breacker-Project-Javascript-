...
import Stage1 from "./Baby/help1.js"
import Stage2 from "./Baby/help2.js"
import Stage3 from "./Baby/help3.js"
...
export default class Baby {
    ...
    mouseHeandler() {
        ...
        this.canvas.onmouseup = () => {
            this.button1.onMouseUp();
            this.button2.onMouseUp();
            this.button3.onMouseUp();
          }
    }
    ...
    draw(){
        ...
        this.ctx.fillText("BABYMODE", 320, 90);
        this.ctx.closePath();
        //노랑색
        this.ctx.beginPath();
        this.ctx.font = "75pt Orbitron";
        ...
        this.ctx.fillText("BABYMODE", 330, 100);
        this.ctx.closePath();
        ...
        this.ctx.textAlign = "center";
        this.ctx.fillStyle = "#49079E";
        this.ctx.fillText("Creator: LEE JUN HYUN", this.canvas.width - 378, 323);
        this.ctx.closePath();
        //노랑색
        this.ctx.beginPath();
        this.ctx.font = "40pt Orbitron";
        this.ctx.textAlign = "center";
        this.ctx.fillStyle = "#FFFA1f"
        this.ctx.fillText("Creator: LEE JUN HYUN", this.canvas.width - 370, 330);
        this.ctx.closePath();
