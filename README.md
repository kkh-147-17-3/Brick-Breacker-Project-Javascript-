...
<img src="https://user-images.githubusercontent.com/102606939/216812356-3d739065-8601-4f71-9afa-6218e36a35be.png" width="700"/>

<br>

<img src="https://user-images.githubusercontent.com/102606939/216812363-7bfe7572-2c5f-4c84-adcd-898e32e89ec0.png" width="700"/>
...
<img src="https://user-images.githubusercontent.com/102606939/216812389-b88ebcd4-4069-47da-8206-b1d4145bbeb7.png" width="500"/>
...
- 게임 구현 시 다음의 요구사항을 반드시 포함하고자 했습니다.
    ...
    - 턴이 끝나면 스테이지의 모든 벽돌이 한 줄씩 아래로 이동한다. 하나의 벽돌이라도 가장 밑으로 내려오면 사용자는 패배한다.
    ...
    - 발사된 공은 스테이지 아래로 내려오면서 발사된 위치로 다시 돌아올 수 있도록 구현하였습니다.
    - 삼각형 벽돌 4 가지 종류를 구현하고, 빗변에 맞는 상황의 충돌로직을 구현하였습니다.
    - 한 턴이 끝나면 스테이지의 모든 벽돌이 한 칸씩 내려오고, 추가벽돌이 있는 경우 새로 한 줄 위에서 생성되도록 구현했습니다.
    - 아이템 벽돌 (레이저, 폭탄, 공 갯수 추가) 를 구현하여 심심할 수 있는 벽돌깨기 게임에 변화를 주고자 했습니다.
